...
const AppSection = ({formInfo, update, sectionTitle, visible, toggleSection}) => {
  return (
    <section className="container border-top pt-3">
      <h2 className='justify-content-between d-flex'>{sectionTitle} <Button className="btn btn-primary" text="Update" btnBackgroundColor="green" toggleSection={toggleSection} visible={!visible}/></h2>
